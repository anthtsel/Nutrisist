...
class FitbitPlatform:
    ...
    def connect(self):
        ...
        try:
            ...
            print(f"Error connecting to Fitbit: {str(e)}")
            return False
    ...
    def disconnect(self):
        ...
        try:
            ...
            print(f"Error disconnecting from Fitbit: {str(e)}")
            return False
    ...
    def _generate_dummy_heart_rate_data(self, start_date, end_date):
        ...
        while current_date <= end_date:
            data.append({
                ...
                'heart_rate': 70 + (current_date.minute % 30),  # Vary between 70-100
                'zone': 'resting'
            })
    ...
    def _generate_dummy_sleep_data(self, start_date, end_date):
        ...
        current_date = start_date
        while current_date <= end_date:
            if 22 <= current_date.hour or current_date.hour < 6:  # Assume sleep between 10 PM and 6 AM
                data.append({
                    'timestamp': current_date.isoformat(),
    ...
    def _generate_dummy_activity_data(self, start_date, end_date):
        ...
        current_date = start_date
        while current_date <= end_date:
            if 8 <= current_date.hour <= 20:  # Assume activity during the day
                data.append({
                    'timestamp': current_date.isoformat(),
                    'steps': 100,
                    'calories_burned': 50,
